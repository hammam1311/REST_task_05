...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingAdminSerializer,UpdateBookingUserSerializer, RegisterSerializer
...
class BookFlight(CreateAPIView):
	serializer_class = UpdateBookingAdminSerializer
